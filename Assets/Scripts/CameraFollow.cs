...
public class CameraFollow : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        transform.position = new Vector3(Mathf.Clamp(playerheading.position.x, -20.58f, 171.4f), Mathf.Clamp(playerheading.position.y, -16.14f, -16.14f), transform.position.z);
